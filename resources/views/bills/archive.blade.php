...
<body>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand"> BILLS / ARCHIVES</a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Archives Bills</h4>
                                    <div class="toolbar">
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($bliisArchive as $index => $bill)
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            ...
                                                            <button class="btn btn-rose btn-fill" data-toggle="modal"
                                                                data-target="#forceDeleteBillModel">
                                                                <i class="material-icons">delete</i>
                                                            </button>
                                                            <button class="btn btn-success btn-fill" data-toggle="modal"
                                                                data-target="#unAcrhiveBillModel">
    ...
    {{-- @extends('models/bills.unarchiveBillModel') --}}
    {{-- @extends('models/bills.forceDeleteBillModel') --}}
