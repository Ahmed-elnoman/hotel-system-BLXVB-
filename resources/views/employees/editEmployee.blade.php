        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="card">
                            <form id="RangeValidation" class="form-horizontal" action="{{ route('employees.update' , $employee->id) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control" type="text" name="first_name" value="{{ $employee->firstName }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <label class="control-label"></label>
                                                <input class="form-control" type="text" name="last_name"  value="{{ $employee->lastName }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <label class="control-label"></label>
                                                <input class="form-control" type="text" name="phone" minLength="5" value="{{ $employee->phone }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="card-footer text-center">
                                    <button type="submit" class="btn btn btn-fill color-purple">Edit EMPLOYEE</button>
                                </div>
                            </form>
                        </div>
                    </div>
