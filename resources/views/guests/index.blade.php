...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn- color-purple">
                                <a href="{{ route('guests.create') }}" style="color: #fff"><i
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Guests Table</h4>
                                    <div class="toolbar">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            ...
                                                            <button class="btn btn-rose btn-fill" data-toggle="modal"
                                                                data-target="#softDeleteGuestModel">
    ...
    @extends('models/guset.softDeleteGuestModel')
