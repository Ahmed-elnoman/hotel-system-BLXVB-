<!-- notice modal -->
<div class="modal fade" id="createPositionModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-notice">
        <div class="modal-content">
            <div class="modal-body">
                <form id="form_unit" action="{{ route('position.store') }}" method="Post">
                    @csrf
                    @method('POST')
                    ...
                    <div class="card-content">
                        <h4 class="card-title">Add Position Forms</h4>
                        ...
                        <div class="form-footer text-right">
                            ...
                            <button type="submit" class="btn btn- btn-fill color-purple">Add</button>
                        </div>
                    </div>
                </form>
            </div>
